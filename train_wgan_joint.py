...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % 100 == 0:
            ...
            fake_data_train = make_fake_data_renorm(args.latent_distr, X_train.shape[0], args.latent_dim, G, means, stds)[:,:4]
            fake_data_test = make_fake_data_renorm(args.latent_distr, X_test.shape[0], args.latent_dim, G, means, stds)[:,:4]
